...
Produced by the run: `docs/findings.md` (API facts measured live), `docs/questions.md` (every question asked of the operator and its answer), `docs/principles.md` (web), `.exomonad/nudges/<label>.jsonl` (the nudge ledger).
