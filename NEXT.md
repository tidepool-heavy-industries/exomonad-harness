...
| Here rescue request43 | retained settings lead; bounded owner34 and read-only audit35 | root base `f504dd062d2383a801462cbdb7cd304bfd54f316`; stopped worker branch `exomonad/settings-recovery-v8/wave-6-here-replacement/branches/here-recovery-fresh-v8` at `f7a766e71b4bcefd2db0562c23df2e296ede4ca2`; new unreviewed candidate `fa649cd78a6ea697d6592dfd9e0214c635b48522` rebased on root `38e3e14` | pre-rebase Here 5/5, active 1/1, full lib 94 pass/0 fail/2 ignored, demo check; **post-rebase checks pending**; cumulative `38e3..fa649` only 3 owned paths | `fa649` still has call,pin,output order and lacks deterministic write_output→append race test; no review/integration | owner34 repair order/race, short-turn checkpoint, post-rebase checks and one exact review; root demo gate afterward |
