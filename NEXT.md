...
- Adapter continuation (2026-09-25): root integration `a70f12ffe543ada826a42863bce7b977712c476e` merges exact actor3 candidate `18d3ee85c7251472bca0408933f8f6f528fe2e3b` over accepted `ef954da` durable contract; integrated replay 11/11, harness lib 113 passed/0 failed/2 ignored, demo binary 36/36. Root scaffolded the final gate as compiling `crates/harness/tests/adapter_readiness.rs` at `a6ac1940dc7e7f42833ec5d6d53828ccb38c4d0f`; exact gate candidate `53a219b` is now merged at `703005fd7400f99f96d958474e5fb533053ec5d3`, with integrated gate 1/1, harness lib 113 passed/2 ignored, demo 36/36. `exomonad/adapter-readiness/wave-1/branches/adapter-replay` at `692adf43b513143116e265f4b45729c784768b71` retains the older 8/8 FIFO fixture but was Repair (not Store-backed), **not merged separately**. `adapter-replay-consumer` at `7c6dcca5baf3748a8f77494271d2585979236f07` contains root demo driver consumer plus older replay fixture; same-reviewer recheck was pending at redeploy, **not accepted or merged**. `exomonad/adapter-replay-combined-review/branches/repair-replay-wait` at `5f9fea6876d6a40b209db3da049219b28aa49f09` adds a replay request-wakeup repair atop `7c6dcca`, **not reviewed or merged**. Preserve these branches; no live inference authorized. Offline harness-side vertical gate closed; adapter-host and held live gates remain separate.
- Vertical gate leaf `exomonad/adapter-readiness/vertical-gate-20260925/branches/vertical-gate-leaf` at `53a219b11f5ef80c8375145a140c67e48e4161f2` contains only `crates/harness/tests/adapter_readiness.rs` over actual base `50eeb606fc346c5cab105174a97617577713b5b3`; reviewer13 Accepted exact candidate on corrected base in request20. Root merged it at `703005fd7400f99f96d958474e5fb533053ec5d3` and ran the integrated checks named above. Reviewer12 request18 was stopped after integration; its old results are not an integration gate. Root audit branch made no edits/checks.
