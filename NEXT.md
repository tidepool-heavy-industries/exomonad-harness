...
| offline replay + fake resident | repair leaf actor3; root durable seam; component reviewer actor9 | `ef954da` durable contract Accepted exact by actor6. Actor3's `18d3ee8` Store-backed ReplayProvider, fake resident fixture and reopen Engine/JobScheduler test passed replay 11/11 and demo check; exact seeded actor9 review reported no blocking defect, 2/2 provider tests. Root merged exact `18d3ee8` in `integrate(adapter-replay-provider)` | integrated replay 11/11, full harness lib 113 passed/0 failed/2 ignored, demo binary 36/36, format/diff checks. Older `692adf4` was Repair (FIFO-only), not used as approval. Final long-cell/3-envelope/strict-final/restart release gate remains open. Old root demo branch `7c6dcca` and wakeup repair `5f9fea6` remain unmerged |
...
- Adapter continuation (2026-09-25): root integration commit `integrate(adapter-replay-provider)` merges exact actor3 candidate `18d3ee85c7251472bca0408933f8f6f528fe2e3b` over accepted `ef954da` durable contract; integrated replay 11/11, harness lib 113 passed/0 failed/2 ignored, demo binary 36/36. `exomonad/adapter-readiness/wave-1/branches/adapter-replay` at `692adf43b513143116e265f4b45729c784768b71` retains the older 8/8 FIFO fixture but was Repair (not Store-backed), **not merged separately**. `adapter-replay-consumer` at `7c6dcca5baf3748a8f77494271d2585979236f07` contains root demo driver consumer plus older replay fixture; same-reviewer recheck was pending at redeploy, **not accepted or merged**. `exomonad/adapter-replay-combined-review/branches/repair-replay-wait` at `5f9fea6876d6a40b209db3da049219b28aa49f09` adds a replay request-wakeup repair atop `7c6dcca`, **not reviewed or merged**. Preserve these branches; no live inference authorized. Long-cell/3-envelope/strict-final/restart vertical gate still open.
